...
use dvizh\shop\controllers\ProductController;
use Yii;
...
class ProductexitemsController extends ProductController
{
...
//                        'roles' => $this->module->adminRoles,
    ...
    public function actionIndex()
    {
        ...
        $searchModel->category_id=Yii::$app->params['ext_items_category_id'];
    ...
    public function actionCreate()
    {
        ...
        $model->category_id=Yii::$app->params['ext_items_category_id'];
